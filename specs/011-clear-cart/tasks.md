...
- [ ] T001 Create clear_cart slice directory at `apps/epoch_web/lib/epoch_web/slices/clear_cart/`
...
- [ ] T002 [P] [US1] Unit test CommandHandler validates non-empty cart in `apps/epoch_web/test/epoch_web/slices/clear_cart_test.exs`
- [ ] T003 [P] [US1] Unit test CommandHandler emits CartCleared event in `apps/epoch_web/test/epoch_web/slices/clear_cart_test.exs`
- [ ] T004 [P] [US1] Unit test CommandHandler returns error for empty cart in `apps/epoch_web/test/epoch_web/slices/clear_cart_test.exs`
- [ ] T005 [P] [US1] Integration test cart display shows empty state after clear in `apps/epoch_web/test/epoch_web/slices/clear_cart_test.exs`

### Implementation for User Story 1

- [ ] T006 [P] [US1] Create ClearCart.Command struct in `apps/epoch_web/lib/epoch_web/slices/clear_cart/command.ex`
- [ ] T007 [US1] Implement ClearCart.CommandHandler with empty cart validation in `apps/epoch_web/lib/epoch_web/slices/clear_cart/command_handler.ex`
...
- [ ] T008 [P] [US2] Unit test Component renders with phx-confirm attribute in `apps/epoch_web/test/epoch_web/slices/clear_cart_test.exs`
- [ ] T009 [P] [US2] Integration test confirming dialog clears cart in `apps/epoch_web/test/epoch_web/slices/clear_cart_test.exs`

### Implementation for User Story 2

- [ ] T010 [US2] Create ClearCart.Component LiveComponent with phx-confirm in `apps/epoch_web/lib/epoch_web/slices/clear_cart/component.ex`
- [ ] T011 [US2] Implement handle_event("clear_cart") delegating to CommandHandler in `apps/epoch_web/lib/epoch_web/slices/clear_cart/component.ex`
- [ ] T012 [US2] Add error handling with flash messages for failures in `apps/epoch_web/lib/epoch_web/slices/clear_cart/component.ex`
...
- [ ] T013 [P] [US3] Unit test Clear Cart button visible when cart has items in `apps/epoch_web/test/epoch_web/slices/clear_cart_test.exs`
- [ ] T014 [P] [US3] Unit test Clear Cart button NOT visible when cart is empty in `apps/epoch_web/test/epoch_web/slices/clear_cart_test.exs`
- [ ] T015 [P] [US3] Integration test button disappears after clearing cart in `apps/epoch_web/test/epoch_web/slices/clear_cart_test.exs`

### Implementation for User Story 3

- [ ] T016 [US3] Integrate ClearCart.Component into CartItems.Live with conditional rendering in `apps/epoch_web/lib/epoch_web/slices/cart_items/live.ex`
...
- [ ] T017 Run full test suite to verify no regressions via `mix test`
